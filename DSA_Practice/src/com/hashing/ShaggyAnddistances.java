...
public class ShaggyAnddistances {
    ...
    static int solve(int[] A) {
        ...
        for(int i=0;i<n;i++){
            ...
            // if it's contains then get the value of repeated element form HashMap 
            // that is the current index(i) - previous element hm.get(A[i]) index = distance of two element
            // we want min use Math.min for minimum distance
